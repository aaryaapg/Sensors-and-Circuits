...
void compareCurrentSaved() {
  //Compare A
  if(int(A_lat*1000) == int(X_lat*1000)){
    if(int(A_long*1000) == int(X_long*1000)){
  ...
  else if(int(A_lat*1000) == int(Y_lat*1000)){
    if(int(A_long*1000) == int(Y_long*1000)){
  ...
  //Compare B
  if(int(B_lat*1000) == int(X_lat*1000)){
    if(int(B_long*1000) == int(X_long*1000)){
  ...
  else if(int(B_lat*1000) == int(Y_lat*1000)){
    if(int(B_long*1000) == int(Y_long*1000)){
  ...
  //Compare C
  if(int(C_lat*1000) == int(X_lat*1000)){
    if(int(C_long*1000) == int(X_long*1000)){
  ...
  else if(int(C_lat*1000) == int(Y_lat*1000)){
    if(int(C_long*1000) == int(Y_long*1000)){
